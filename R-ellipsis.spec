...
Version  : 0.2.0
Release  : 10
URL      : https://cran.r-project.org/src/contrib/ellipsis_0.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ellipsis_0.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1561088406
